"""
Additional comprehensive tests for deployment routes
Tests edge cases and additional scenarios to increase coverage
"""
...
from app.schemas.model import ModelDeploymentResponse, DeploymentStatus, ModelDeploymentUpdate


class TestDeploymentRoutesAdditional:
    """Test additional deployment route scenarios"""
    ...
    async def test_list_deployments_with_filters(self, mock_list, client):
        """Test listing deployments with all filters"""
    ...
    async def test_update_deployment_patch(self, mock_update, client, test_model):
        """Test PATCH update deployment endpoint"""
        mock_response = ModelDeploymentResponse(
            id="deploy_123",
    ...
    @pytest.mark.asyncio
    @patch('app.services.deployment_service.deployment_service.update_deployment', new_callable=AsyncMock)
    async def test_update_deployment_put(self, mock_update, client, test_model):
        """Test PUT update deployment endpoint"""
        mock_response = ModelDeploymentResponse(
            id="deploy_123",
            model_id=test_model.id,
            name="updated_deployment",
    ...
    async def test_delete_deployment_not_found_error(self, mock_delete, client):
        """Test deleting deployment with not found error"""
